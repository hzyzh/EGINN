...
print(dataset[0].batch)
print(dataset[0].x)
print(dataset[0].edge_index)
print(dataset[1].x)
print(dataset[1].edge_index)
train_loader = DataLoader(dataset[:500], batch_size=2, shuffle=False)
val_loader = DataLoader(dataset[500:3000], batch_size=2)
test_loader = DataLoader(dataset[3000:], batch_size=2)
